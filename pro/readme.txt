...
= 1.10.3 (Date: November 17, 2025) =
* Fixed: Paid Memberships Pro widget was not visible for some customers.

= 1.10.1 (Date: November 03, 2025) =
* Fixed: Fixed undefined safeUnserialize method error
